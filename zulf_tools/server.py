...
def inspect_fid_crops(group_run_id: str, ranges: list[list[float]], discovery_groups: list[int],
                      ...
                      early_duration_s: float = 1., early_amplitude_ratios: list[float] | None = None) -> dict:
    ...
    return jobs.start_analysis('inspect_fid_crops',dict(group_run_id=group_run_id,ranges=ranges,
        ...
        sg_order=sg_order,width_s=width_s,snr_threshold=snr_threshold,early_block_s=early_block_s,
        early_duration_s=early_duration_s,early_amplitude_ratios=early_amplitude_ratios))
